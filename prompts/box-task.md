...
4. Spawn Codex with `box prompt --provider codex --model gpt-5.4 --reasoning-effort medium --json <box-id> "$ARGUMENTS"`. Preserve the user's task verbatim; do not broaden or rewrite it.
