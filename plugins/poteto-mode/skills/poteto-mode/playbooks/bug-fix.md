...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a Codex collaboration agent with a specific scope; review the diff.
