...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to a Codex collaboration agent with a tight scope; review the diff. Capture a post-fix trace.
