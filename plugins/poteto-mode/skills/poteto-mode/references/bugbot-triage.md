...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and the ordered PR branches, upper-stack diffs, or PR context show it is used by a later PR in the stack.
