...
- `Read` tool calls against any `SKILL.md` file (workspace `.codex/skills/`, user-level `.codex/skills/`, or plugin-installed paths under `~/.codex/skills/`)
- Collaboration-agent prompts that name a skill path
